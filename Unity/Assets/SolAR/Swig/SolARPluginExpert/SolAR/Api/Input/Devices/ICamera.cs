...
public class ICamera : IComponentIntrospect {
  ...
  public virtual void setParameters(CameraParameters parameters) {
    solar_api_input_devicesPINVOKE.ICamera_setParameters(swigCPtr, CameraParameters.getCPtr(parameters));
    if (solar_api_input_devicesPINVOKE.SWIGPendingException.Pending) throw solar_api_input_devicesPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public virtual CameraParameters getParameters() {
    CameraParameters ret = new CameraParameters(solar_api_input_devicesPINVOKE.ICamera_getParameters(swigCPtr), false);
    if (solar_api_input_devicesPINVOKE.SWIGPendingException.Pending) throw solar_api_input_devicesPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
