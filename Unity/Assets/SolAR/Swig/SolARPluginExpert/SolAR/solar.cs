...
public class solar {
  ...
  public static I2Dto3DTransformDecomposerValidation bindTo_I2Dto3DTransformDecomposerValidation(IComponentIntrospect component) {
    global::System.IntPtr cPtr = solarPINVOKE.bindTo_I2Dto3DTransformDecomposerValidation(IComponentIntrospect.getCPtr(component));
    I2Dto3DTransformDecomposerValidation ret = (cPtr == global::System.IntPtr.Zero) ? null : new I2Dto3DTransformDecomposerValidation(cPtr, true);
    if (solarPINVOKE.SWIGPendingException.Pending) throw solarPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
