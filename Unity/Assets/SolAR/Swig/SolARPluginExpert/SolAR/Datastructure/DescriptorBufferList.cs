...
public class DescriptorBufferList : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<DescriptorBuffer>
 {
  ...
  public DescriptorBufferList(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public DescriptorBufferList(global::System.Collections.Generic.IEnumerable<DescriptorBuffer> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (DescriptorBuffer element in c) {
      this.Add(element);
  ...
  public DescriptorBuffer[] ToArray() {
    DescriptorBuffer[] array = new DescriptorBuffer[this.Count];
    this.CopyTo(array);
    return array;
  }
