...
public class solar_datastructure {
  public static DescriptorBufferIterator begin(DescriptorBuffer ref_) {
    DescriptorBufferIterator ret = new DescriptorBufferIterator(solar_datastructurePINVOKE.begin(DescriptorBuffer.getCPtr(ref_)), true);
  ...
  public static global::System.IntPtr newPointer_Contour2Df() {
    global::System.IntPtr ret = solar_datastructurePINVOKE.newPointer_Contour2Df();
    if (solar_datastructurePINVOKE.SWIGPendingException.Pending) throw solar_datastructurePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
