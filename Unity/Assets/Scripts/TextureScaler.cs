...
public class TextureScaler
{
	...
	public static Texture2D scaled(WebCamTexture src, int width, int height)
	{
		Rect texR = new Rect(0, 0, width, height);
		_gpu_scale(src, width, height);
	...
	static void _gpu_scale(WebCamTexture src, int width, int height)
	{
